...
import 'package:smart_flo_meet_example/utils.dart';
import 'package:smart_flo_meet_example/video_call.dart';
...
class _State extends State<MyApp> {
  ...
  static const String kBaseURL = "https://demo.smartflomeet.ttns.in/";
  /* To try the app with SmartFloMeet hosted service you need to set the kTry = true */
  static bool kTry = true;
  /*Use smartflowmeet portal to create your app and get these following credentials*/
